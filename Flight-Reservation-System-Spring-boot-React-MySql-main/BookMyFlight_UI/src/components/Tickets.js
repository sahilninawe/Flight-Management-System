    ...
    constructor(props){
        ...
        if(!localStorage.getItem('user'))
        {
            ...
            this.service.getTickets().then(response => {
                //it is a callback function that is executed when the HTTP request is complete and the response is received. 
                //The response object is passed to this function as an argument.
                //This allows the component to wait for the server response before rendering the tickets data.
