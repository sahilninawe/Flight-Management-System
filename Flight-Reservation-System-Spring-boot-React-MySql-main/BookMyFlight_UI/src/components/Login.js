...
export default class Login extends Component{
    ...
    constructor(props){
        super(props);
        this.service=new UserService();  //creating an instance of the UserService class.
        this.state={ // initializing the state of the component with several properties
            username:"",
            password:"",
            errormsg:"",
            flag:false,
    ...
    validateUser=()=>{
        ...
        if(this.state.username!==''&& this.state.password!==''){ 
            //The then method is called on the returned promise to handle the response.
