    ...
    return (
       ...
       <div class='pt-3'>
        ...
        <div class="py-5" style={{backgroundImage: `url(${planeBG})`,overflow: 'hidden', height: '700px'}}>
            ...
            <div style={{textAlign:'right', marginRight:'90pt', marginTop:'200pt'}}>
            <ReactToPrint //The trigger prop is a function that returns a React element that will be used as the print button.
                trigger={() => <a class="btn text-light bg-dark" role="button" href="#">Print The Ticket</a>}
                content={() => this.componentRef}//The content prop is a function that returns a React element that will be printed.
            />
            </div>
